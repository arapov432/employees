      ...
      <div className="list">
        ...
        <div className="row header">
          ...
          <div
            className="cell"
            onClick={() => {
              this.props.sort("first_name");
            }}
          >
            Full Name
            <i
              className={
                this.props.sorted && this.props.sortBy === "first_name"
                  ? "fa fa-sort-asc"
                  : "fa fa-sort-desc"
              }
              aria-hidden="true"
          ...
          >
            ...
            <i
              className={
                this.props.sorted && this.props.sortBy === "email"
                  ? "fa fa-sort-asc"
                  : "fa fa-sort-desc"
              }
              aria-hidden="true"
          ...
          <div
            className="cell"
            onClick={() => {
              this.props.sort("city");
            }}
          >
            City
            <i
              className={
                this.props.sorted && this.props.sortBy === "city"
                  ? "fa fa-sort-asc"
                  : "fa fa-sort-desc"
              }
              aria-hidden="true"
          ...
          <div
            className="cell"
            onClick={() => {
              this.props.sort("state");
            }}
          >
            State
            <i
              className={
                this.props.sorted && this.props.sortBy === "state"
                  ? "fa fa-sort-asc"
                  : "fa fa-sort-desc"
              }
              aria-hidden="true"
